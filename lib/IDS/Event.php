 ...
 * PHPIDS event object
 *
 * This class represents a certain event that occured while applying the filters to the
 * supplied data. It aggregates a bunch of IDS_Filter implementations and is a assembled in
 * IDS_Report.
 *
