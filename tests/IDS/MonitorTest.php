...
class IDS_MonitorTest extends PHPUnit_Framework_TestCase {
    ...
    public function testConcatenatedXSSList() {
        ...
        $result = $test->run();
        $this->assertEquals(1127, $result->getImpact());
    }
    ...
    public function testConcatenatedXSSList2() {
        ...
        $result = $test->run();
	$this->assertImpact($result, 940, 927);
    }
    ...
    public function testXSSList() {
        ...
        $result = $test->run();
        $this->assertImpact($result, 789, 834);
    }
    ...
    public function testSelfContainedXSSList() {
        ...
        $result = $test->run();
        $this->assertImpact($result, 531, 544);
    }
    ...
    public function testSQLIList2() {
        ...
        $result = $test->run();
        $this->assertImpact($result, 582, 624);
    }
    ...
    public function testSQLIList3() {
        ...
        $result = $test->run();
        $this->assertEquals(555, $result->getImpact());
    }
    ...
    public function testSQLIList4() {
        ...
        $result = $test->run();
        $this->assertImpact($result, 757, 761);
    }
    ...
    public function testSQLIList5() {
        ...
        $result = $test->run();
        $this->assertImpact($result, 913, 926);
    }
    ...
    public function testURIList(){
        ...
        $result = $test->run();
        $this->assertImpact($result, 143, 148);
    }
    ...
    public function testRFEList() {
        ...
        $result = $test->run();
        $this->assertImpact($result, 519, 514);
    }
