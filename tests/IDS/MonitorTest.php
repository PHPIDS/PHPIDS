...
class IDS_MonitorTest extends PHPUnit_Framework_TestCase {
    ...
    public function testConcatenatedXSSList() {
        ...
        $result = $test->run();
        $this->assertTrue($result->hasEvent(1));
        $this->assertEquals(559, $result->getImpact());
    ...
    public function testSQLIList() {
        ...
        $result = $test->run();
        $this->assertTrue($result->hasEvent(1));
        $this->assertEquals(444, $result->getImpact());
    }
    ...
    public function testSQLIList3() {
        ...
        $result = $test->run();
        $this->assertTrue($result->hasEvent(1));
        $this->assertEquals(398, $result->getImpact());
    }
    ...
    public function testSQLIList5() {
        ...
        $result = $test->run();
        $this->assertTrue($result->hasEvent(1));
        $this->assertEquals(240, $result->getImpact());
    }    
