...
class IDS_MonitorTest extends PHPUnit_Framework_TestCase {
    ...
    public function testConcatenatedXSSList() {
        ...
        $result = $test->run();
        $this->assertTrue($result->hasEvent(1));
        $this->assertEquals(849, $result->getImpact());
    ...
    public function testXSSList() {
        ...
        $this->assertEquals(368, $result->getImpact());
    }
    ...
    public function testSelfContainedXSSList() {
        ...
        $result = $test->run();
        $this->assertTrue($result->hasEvent(1));
        $this->assertEquals(405, $result->getImpact());
    }
    ...
    public function testSQLIList3() {
        ...
        $result = $test->run();
        $this->assertTrue($result->hasEvent(1));
        $this->assertEquals(539, $result->getImpact());
    }
    ...
    public function testSQLIList5() {
        ...
        $result = $test->run();
        $this->assertTrue($result->hasEvent(1));
        $this->assertEquals(543, $result->getImpact());
    }    
    ...
    public function testOctalCCConverter() {
        ...
        $result = $test->run();
        $this->assertTrue($result->hasEvent(1));
        $this->assertEquals(49, $result->getImpact());
    }
