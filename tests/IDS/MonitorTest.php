...
class IDS_MonitorTest extends PHPUnit_Framework_TestCase {
    ...
    public function testXSSList() {
        ...
        $result = $test->run();
        $this->assertImpact($result, 752, 787);
    }
    ...
    public function testSelfContainedXSSList() {
        ...
        $result = $test->run();
        $this->assertImpact($result, 519, 532);
    }
    ...
    public function testSQLIList2() {
        ...
        $result = $test->run();
        $this->assertImpact($result, 593, 635);
    }
    ...
    public function testSQLIList3() {
        ...
        $result = $test->run();
        $this->assertEquals(575, $result->getImpact());
    }
    ...
    public function testSQLIList5() {
        ...
        $result = $test->run();
        $this->assertImpact($result, 925, 938);
    }
    ...
    public function testSQLIList6() {
        ...
        $result = $test->run();
        $this->assertEquals(413, $result->getImpact());
    }
