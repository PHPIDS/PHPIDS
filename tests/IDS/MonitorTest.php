...
class IDS_MonitorTest extends PHPUnit_Framework_TestCase {
    ...
    public function testConcatenatedXSSList() {
        ...
        $result = $test->run();
        $this->assertTrue($result->hasEvent(1));
        $this->assertEquals(573, $result->getImpact());
    ...
    public function testConcatenatedXSSList2() {
        ...
        $this->assertEquals(263, $result->getImpact());
    }
    ...
    public function testXMLPredicateXSSList() {
        ...
        $this->assertEquals(52, $result->getImpact());
    }
    ...
    public function testXSSList() {
        ...
        $this->assertEquals(159, $result->getImpact());
    }
    ...
    public function testSelfContainedXSSList() {
        ...
        $result = $test->run();
        $this->assertTrue($result->hasEvent(1));
        $this->assertEquals(346, $result->getImpact());
    }
    ...
    public function testSQLIList3() {
        ...
        $result = $test->run();
        $this->assertTrue($result->hasEvent(1));
        $this->assertEquals(426, $result->getImpact());
    }
