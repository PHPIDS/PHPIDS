...
class IDS_MonitorTest extends PHPUnit_Framework_TestCase {
    ...
    public function testConcatenatedXSSList() {
        ...
        $result = $test->run();
        $this->assertEquals(1130, $result->getImpact());
    }
    ...
    public function testConcatenatedXSSList2() {
        ...
        $result = $test->run();
	$this->assertImpact($result, 842, 825);
    }
    ...
    public function testXSSList() {
        ...
        $result = $test->run();
        $this->assertImpact($result, 536, 556);
    }
    ...
    public function testSQLIList() {
        ...
        $result = $test->run();
        $this->assertEquals(485, $result->getImpact());
    }
    ...
    public function testURIList(){
        ...
        $result = $test->run();
        $this->assertImpact($result, 156, 161);
    }
    ...
    public function testRFEList() {
        ...
        $result = $test->run();
        $this->assertImpact($result, 487, 482);
    }
    ...
    public function testHexCCConverter() {
        ...
        $result = $test->run();
        $this->assertImpact($result, 125, 120);
    }
