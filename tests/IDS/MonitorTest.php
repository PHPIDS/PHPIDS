...
class IDS_MonitorTest extends PHPUnit_Framework_TestCase {
    ...
    public function testAttributeBreakerList() {
        ...
        $result = $test->run();
        $this->assertEquals(43, $result->getImpact());
    }
    ...
    public function testConcatenatedXSSList() {
        ...
        $result = $test->run();
        $this->assertEquals(1113, $result->getImpact());
    }
    ...
    public function testConcatenatedXSSList2() {
        ...
        $result = $test->run();
	$this->assertImpact($result, 863, 851);
    }
    ...
    public function testXSSList() {
        ...
        $result = $test->run();
        $this->assertImpact($result, 571, 595);
    }
    ...
    public function testSQLIList() {
        ...
        $result = $test->run();
        $this->assertEquals(490, $result->getImpact());
    }
    ...
    public function testSQLIList2() {
        ...
        $result = $test->run();
        $this->assertImpact($result, 597, 639);
    }
    ...
    public function testSQLIList5() {
        ...
        $result = $test->run();
        $this->assertImpact($result, 914, 927);
    }
    ...
    public function testSQLIList6() {
        ...
        $result = $test->run();
        $this->assertEquals(329, $result->getImpact());
    }
