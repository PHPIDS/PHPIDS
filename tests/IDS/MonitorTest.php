...
class IDS_MonitorTest extends PHPUnit_Framework_TestCase {
    ...
    public function testConcatenatedXSSList() {
        ...
        $result = $test->run();
        $this->assertTrue($result->hasEvent(1));
        $this->assertEquals(839, $result->getImpact());
    ...
    public function testSelfContainedXSSList() {
        ...
        $result = $test->run();
        $this->assertTrue($result->hasEvent(1));
        $this->assertEquals(395, $result->getImpact());
    }
    ...
    public function testSQLIList() {
        ...
        $result = $test->run();
        $this->assertTrue($result->hasEvent(1));
        $this->assertEquals(445, $result->getImpact());
    }
    ...
    public function testSQLIList4() {
        ...
        $result = $test->run();
        $this->assertTrue($result->hasEvent(1));
        $this->assertEquals(610, $result->getImpact());
    }
    ...
    public function testHexCCConverter() {
        ...
        $result = $test->run();
        $this->assertTrue($result->hasEvent(1));
        $this->assertEquals(146, $result->getImpact());
    }
